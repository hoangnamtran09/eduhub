...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, type, error, label, helperText, id, variant = "default", leftIcon, rightIcon, ...props }, ref) => {
    ...
    const variantStyles = {
      default: "border border-ink-200 rounded-lg px-4 py-3 focus:ring-2 focus:ring-brand-500/30 focus:border-brand-500",
      filled: "border border-transparent rounded-lg px-4 py-3 bg-paper-200 focus:bg-white focus:border-ink-200 focus:ring-2 focus:ring-brand-500/30",
    ...
    return (
      <div className="w-full space-y-1.5">
        ...
        <textarea
          id={textareaId}
          className={cn(
             "w-full px-4 py-3 bg-white border border-ink-200 rounded-lg",
